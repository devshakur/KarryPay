...
// const testimonies = [
//   {
//     text: "Since I started using KarryPay, receiving payments from my customers has been seamless. I don’t worry about delays anymore — the instant transfers have completely changed the way I run my small tailoring business. I also love the KarrySave feature, it helps me put money aside without even realizing it.",
...
//   return (
//     <div className="w-full max-w-md mx-auto py-10 flex justify-center">
//       <Swiper
//         modules={[Autoplay]}
//         slidesPerView={1}
//         autoplay={{
